  ...
  return (
    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View className="flex-1 bg-[#FFAE00] relative">
          <Image
            source={require('../../assets/images/full_icon.png')}
            className="absolute top-[15%] left-1/2 -translate-x-1/2 -translate-y-[120px] w-[260px] h-[260px] z-20"
            resizeMode="contain"
          />
          <View className="relative w-full flex-1 justify-end">
            <View className="w-full h-[85%] bg-white rounded-t-[30px] px-12 pt-[30%] pb-12 gap-3">
          <View className="">
