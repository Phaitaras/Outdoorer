...
const GoogleIcon = createIcon({
  ...
  path: (
    <>
      {/* Blue segment */}
      <Path
        d="M24 12c3.5 0 6.6 1.2 9 3.4l6-6C36.7 6 30.8 4 24 4 14.9 4 6.9 9 3 17l7 5c1.6-4.6 6-10 14-10z"
        fill="#4285F4"
      />
      {/* Red segment */}
      <Path
        d="M46 24c0-1.6-.2-3.2-.6-4.7H24v9h12.6c-.6 3.4-2.9 6.3-6 8.1l7 5C43.5 37.6 46 31.2 46 24z"
        fill="#EA4335"
      />
      {/* Yellow segment */}
      <Path
        d="M10 29c1.9 5.4 6.9 9.6 13.9 10.4 7.8.9 15.1-2.6 19.6-8.6l-7-5c-2 3.1-5.4 5.5-9.8 5-4.6-.6-8.5-4-9.7-8.4l-6 1.6z"
        fill="#FBBC05"
      />
      {/* Green segment */}
      <Path
        d="M24 44c6.8 0 12.7-2 17.1-5.4l-7-5c-2.6 1.8-6 3-10.1 2.4-4.9-.7-8.9-3.9-10.8-8.2l-7 5C6.9 39 14.9 44 24 44z"
        fill="#34A853"
      />
    </>
  ),
